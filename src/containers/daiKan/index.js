...
import kefu from '@/assets/img/homeimg/kefu.png';
import yuyue from '@/assets/img/homeimg/yuyue1.png';
import fenxiang from '@/assets/img/homeimg/fenxiang.png';
import phone from '@/assets/img/homeimg/phone.png';
...
import { relativeTimeThreshold } from 'moment';
 ...
 const webSocketIp = '47.94.138.117:8001';
  ...
  componentDidMount() {
    ...
    if(!socketConnected){
      ...
      socket.onmessage=function(event){
        ...
        var ifr = document.getElementById("iframe3D_daiKanPage");
        // console.log(event.data);
        ifr.src = event.data;
      }
    }
  ...
  render() {
    ...
    return (
      <div className='diymuxueindexconten'>
        ...
        <Head title='在线带看' handleBack={this.handleBack} />
        {/* <div
        ...
        {showItemsTabs ? <div style={{ width: '100%', height: '40vh', zIndex: 100, position: 'absolute', bottom: 72, overflow: 'auto', overflowX: 'hidden' }} >
        ...
        <div className={this.state.topjudge ? "dropdownsDK" : "dropdownsaDK"} style={{ display: this.state.showServices ? 'block' : 'none' }}>
        ...
        {/* <div className='phoneIcon'>
          ...
          {/* <div className="indexFenxiang">  
           <img src={fenxiang} ></img>
            <div style={{fontSize:'11px'}}>分享</div>
          </div> */}

          <div onClick={() => this.handleYuYue(true)} className='indexYuyue'>
            <img src={yuyue} ></img>
          <div style={{fontSize:'11px'}}>预约看墓</div>
          </div>

          <div onClick={() => this.handleServices(true)}  className='indexKefu'>
            <img src={kefu} ></img>
            <div style={{fontSize:'11px'}}>联系客服</div>
          </div>

          <div className='indexPone'>
              <a href="tel:17717975246"><img src={phone}/></a>
              <div style={{fontSize:'11px'}}>拨打电话</div>
          </div>

        {/* <div className='diymuxueindex' style={{backgroundColor:'rgba(0,0,0,0)'}} >
          <div></div>
          <div></div>
          <div onClick={() => this.handleServices(true)}>
