...
class AlarmDetail extends React.Component{
  ...
  render(){
    ...
    return (
      <div className='deviceAlarmDetail-body'>
        <div className='deviceAlarmDetail-content'>
            <div className='tabs-item'>
              <div>
                ...
                <div className='message-tip'>
                  ...
                  <div className='nomessage-text'>暂无告警信息</div>
                </div>:
                //数据循环输出到列表
                    ...
                    <List key={index} onClick={()=>this.handleGoDetailPage(props,e.id)}>
                      <Item className='item-list'>
                        <div className='item-left'>
                          ...
                          <div className='deviceAlarmDetail-type' style={{color:'#04C5B2'}}>
                            {alarmType[1]}
                          </div>
                        </div>
