...
import { pointDeviceList, saveDeviceInfo, doSBXJ, doSBBY, doSBYX, saveSBXJ, saveSBBY, saveSBYX } from '@/redux/task/task.action';
...
@connect(
  ...
  { pointDeviceList, saveDeviceInfo, doSBXJ, doSBBY, doSBYX, saveSBXJ, saveSBBY, saveSBYX }
)
@withRouter
@form
class FinishDeviceInfo extends React.Component{
  constructor(props) {
    super(props);
    this.state = {
      // new------------
                          ...
                          <div style={{display:'flex', justifyContent:'space-between', width:'100%', padding:'6px 0', borderBottom:'1px solid #efefef', marginBottom:10}}>
                            ...
                            <div style={{ width:52 }}>
                              <Switch
                                ...
                                // onChange={()=>this.onSwitchChange(e.key)}
                              />
                            </div>
                          </div>
                        // 图片型
                          ...
                          <div style={{width:'100%', padding:'6px 0', borderBottom:'1px solid #efefef'}}>
                            ...
                            <div style={{ width:'100%' }}>
                              <InputItem
                                ...
                                placeholder=''
                                disabled
                                // onChange={(v)=>this.onInputChange(e.key,v)}
                              ></InputItem>
                            </div>
                          </div>
                        :null
...
export default FinishDeviceInfo;