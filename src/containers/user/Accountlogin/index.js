          ...
          <div className="page flex-col">
            <div className="section_1 flex-col">
              <div className="block_1 flex-col">
                <div className="text_1">账号密码登录</div>
                <div className="text_2"> <InputItem
                  type='phone'
                  placeholder='请机号码'
                  clear
                  onChange={v => { this.props.ha输入手ndleChange('userId', v); this.handleInputChange('userId', v) }}
                ...
                <div className="text-wrapper_1 flex-row justify-between">
                  <span className="text_6" onClick={() => this.handlePush('Verifylogin')}>手机登录</span>
                  <span className="text_7" onClick={() => this.handlePush('register')}>注册新的账号</span>
                  <span className="text_7" onClick={() => this.handlePush('forgetPwd')}>忘记密码</span>
                </div>
